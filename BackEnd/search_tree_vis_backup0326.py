...
def compute_single_level_nearest_neighbor (interior_cluster_index, tree_vis_latent_vector, tree_vis_index, nearest_neighbor_res):
    ...
    print('parent_cluster_depth', parent_cluster_depth, 'parent_cluster_index', interior_parent_cluster_index)
    for sibling_cluster_index in sibling_cluster_list:
        ...
        if sibling_cluster_index != interior_cluster_index:
            print('sibling_cluster_index', sibling_cluster_index)
            nearest_neighbor_list = compute_nearest_neighbor_from_interior_cluster(tree_vis_latent_vector, sibling_cluster_index)
...
def compute_nearest_neighbor_from_interior_cluster(target_tree_vis_latent_vector, interior_cluster_index):
    '''
...
def compute_neighbor_representative_by_node_index(treevis_index):
    ...
    print('leaf_cluster_index', leaf_cluster_index, 'interior_cluster_index', interior_cluster_index)
...
def compute_neighbor_representative(max_displayed_level, displayed_level, target_treevis_index):
    ...
    if displayed_cluster_level < traverse_path_clusters_results_file_path:
        displayed_cluster_level = str(traverse_path_clusters_results_file_path)
    else:
    ...
    for level in range(traverse_path_clusters_results_max_level, int(displayed_cluster_level)-1, -1):
        ...
        index_list = []
        for nearest_neighbor_obj in nearest_neighbor_list:
            index_list.append(nearest_neighbor_obj['index'])
